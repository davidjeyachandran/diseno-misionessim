jQuery(document).ready(function(){
  ...
  jQuery("#block-views-block-view-1-block-1 .views-view-grid > .row > .col-sm-3 .views-field-title a").wrapInner("<div><h2></h2></div>");
  jQuery("#block-views-block-view-1-block-1 .views-view-grid > .row > .col-sm-3 .views-field-title a > div").addClass("item-html");
